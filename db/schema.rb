...
ActiveRecord::Schema.define(version: 20161104211957) do
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.integer  "prealert_id", limit: 4
    t.datetime "created_at",              null: false
    t.datetime "updated_at",              null: false
  end

  add_index "orders", ["prealert_id"], name: "index_orders_on_prealert_id", using: :btree

  create_table "prealerts", force: :cascade do |t|
    t.string   "tracking_number", limit: 255
    t.string   "curier",          limit: 255
  ...
  add_foreign_key "orders", "prealerts"
  add_foreign_key "prealerts", "users"
end
